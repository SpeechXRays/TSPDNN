...
def main():
    ...
    pairsDefault = os.path.expanduser("/home/amine/openface/evaluation/pairs.txt")
    parser.add_argument('--lfwPairs', type=str,
                        default=os.path.expanduser(
                            "/home/amine/openface/evaluation/pairs.txt"),
